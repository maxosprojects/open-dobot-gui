    ...
    def pushButtonMoveToCoordinate_clicked(self):
        ...
        if (moveToX == '' or moveToY == '' or moveToZ == ''):
            self.show_a_warning_message_box('Missing a coordinate value.',
                                            'Check that you entered a dimension for each value.',
        ...
        self.arduinoSerial.write( struct.pack('f',moveToAngles[1]) )
        self.arduinoSerial.write( struct.pack('f',moveToAngles[2]) )
